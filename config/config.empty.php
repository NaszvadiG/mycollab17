<?php
  ...
  define('APPLICATION_MODULES', 'system,discussions,milestones,files,calendar,tasks,status,documents,project_exporter,tracking,invoicing,notebooks,source,ms_project_manager,password_policy,footprints');
