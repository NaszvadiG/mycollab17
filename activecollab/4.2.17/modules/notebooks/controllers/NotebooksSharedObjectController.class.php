  ...
  class NotebooksSharedObjectController extends SharedObjectController {
    ...
    function notebook_page() {
      ...
      $this->response->assign(array(
        'active_shared_notebook_page' => $this->active_shared_notebook_page,
        'active_shared_notebook_page_attachments' => Attachments::findByParent($this->active_shared_notebook_page),
      ));
