    ...
    function index() {
      if($this->request->isAsyncCall()) {
        $settings_data = $this->request->post('settings', ConfigOptions::getValue(array(
          ...
          'multiple_assignees_for_milestones_and_tasks'
        )));
        ...
        if($this->request->isSubmitted()) {
          try {
            ConfigOptions::setValue(array(
              ...
              'multiple_assignees_for_milestones_and_tasks' => (boolean) $settings_data['multiple_assignees_for_milestones_and_tasks']
        		));
