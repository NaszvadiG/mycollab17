        ...
        if(Companies::canAdd($this->logged_user)) {
          ...
          if($this->request->isSubmitted()) {
            try {
              ...
              AngieApplication::cache()->removeByModel(Users::getModelName(true));
              AngieApplication::cache()->removeByObject($this->logged_user, 'visible_user_ids');
              AngieApplication::cache()->removeByObject(Companies::findById(array_var($invite_data, 'company_id')));
