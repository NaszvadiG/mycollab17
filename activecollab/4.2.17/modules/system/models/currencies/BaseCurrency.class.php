<?php
  ...
  abstract class BaseCurrency extends ApplicationObject {
     ...
     * @var array
     */
    protected $fields = array('id', 'name', 'code', 'decimal_spaces', 'decimal_rounding', 'is_default', 'code_position');
    ...
    /**
     * Return value of code_position field
     *
     * @return string
     */
    function getCodePosition() {
      return $this->getFieldValue('code_position');
    } // getCodePosition
    
    /**
     * Set value of code_position field
     *
     * @param string $value
     * @return string
     */
    function setCodePosition($value) {
      return $this->setFieldValue('code_position', $value);
    } // setCodePosition
