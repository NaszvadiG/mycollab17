...
{if ($show_instructions)}
  <div class="wireframe_content_wrapper shared_object_instructions">
    <div class="object_body_content">
      ...
      <p>{lang}You will also receive a confirmation email with details of how to track the progress of your inquiry. If you do not receive this email please check your junk mail folder.{/lang}</p>
    </div>
  </div>
