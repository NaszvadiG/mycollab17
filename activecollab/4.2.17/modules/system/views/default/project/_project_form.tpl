...
<div class="big_form_wrapper two_form_sidebars">
  ...
  {if $project_data.based_on_type && $project_data.based_on_type == 'Quote'}
    {wrap field=create_milestones class='based_on_quote'}
      {yes_no name='project[create_milestones]' data=$project_data.milestones yes_text="Yes, create them" no_text="Don't create" label='Milestones based on Quote Items' id='create_milestones'}
    {/wrap}
  {/if}
