    ...
    <div class="content_stack_wrapper">
      ...
      <div class="content_stack_element">
        ...
        <div class="content_stack_element_body">
          ...
          {wrap field=multiple_assignees_for_milestones_and_tasks}
          {yes_no name="settings[multiple_assignees_for_milestones_and_tasks]" value=$settings_data.multiple_assignees_for_milestones_and_tasks label='Enable Multiple Assignees for Milestones and Tasks'}
            <p class="aid">{lang}Set this option to Yes if you want to have multiple users assigned to milestones and tasks{/lang}.</p>
          {/wrap}
        </div>
      </div>
