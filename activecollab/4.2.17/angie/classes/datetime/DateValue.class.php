<?php
  ...
  class DateValue implements IDescribe, IJSON {
     ...
     * @return string
     */
    function formatForUser($user = null, $offset = null, $language = null) {
      ...
      return $this->__formatForUser($format, ($offset === null ? get_user_gmt_offset($user) : (integer) $offset), $language);
    } // formatForUser
     ...
     * @return string
     */
    function formatDateForUser($user = null, $offset = null, $language = null) {
     ...
     * @return string
     */
    protected function __formatForUser($format, $offset, $language = null) {
