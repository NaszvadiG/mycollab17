  ...
  abstract class AngieApplicationUpgraderAdapter {
    ...
    function validateBeforeUpgrade($params) {
      ...
      if(extension_loaded('mysqli')) {
        $this->validationLogOk('MySQLi extension is available');
      } else {
        $this->validationLogError('Required MySQLi PHP extension was not found. Please install it before continuing');
      } // if
