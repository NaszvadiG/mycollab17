<?php
  ...
  class AngieMigrationDelegate extends AngieDelegate {
     ...
     * @return array
     */
    function down($timestamp = null, $output = null) {
      if($timestamp) {
     ...
     * @throws Exception
     */
    private function executeMigrationUp(AngieModelMigration $migration, array &$batch, $output = null) {
