...
{wrap field=exp_date}
  ...
  {select_month name='payment[cc_expiration_month]' id="cc_expiration_month" value=$payment_data.cc_expiration_month required=true}
  {select_year name='payment[cc_expiration_year]' id="cc_expiration_year" value=$payment_data.cc_expiration_year required=true from=$today->getYear()}
  
{/wrap}

{wrap field=address_1}
  {label for=address1 required=yes}Address{/label}
