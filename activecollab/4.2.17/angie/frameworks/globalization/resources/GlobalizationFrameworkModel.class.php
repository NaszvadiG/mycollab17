  ...
  class GlobalizationFrameworkModel extends AngieFrameworkModel {
    ...
    function __construct(GlobalizationFramework $parent) {
      ...
      $this->addModel(DB::createTable('currencies')->addColumns(array(
        ...
        DBEnumColumn::create('code_position', array('left', 'right'))
      ))->addIndices(array(
    ...
    function loadInitialData($environment = null) {
      ...
      $this->loadTableData('currencies', array(
        array('name' => 'Euro', 'code' => 'EUR', 'code_position' => 'left'),
        array('name' => 'US Dollar', 'code' => 'USD', 'is_default' => true, 'code_position' => 'left'),
        array('name' => 'British Pound', 'code' => 'GBP', 'code_position' => 'left'),
        array('name' => 'Japanese Yen', 'code' => 'JPY', 'code_position' => 'left'),
      ));
